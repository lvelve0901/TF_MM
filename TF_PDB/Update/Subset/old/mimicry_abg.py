...
mminfo = pd.read_csv("../../../Paper/final_cutoff_mm_sigma%.1f.csv"%sigma)
...
print(output_df)
output_df.to_csv("mimicry_abg_sigma%.1f.csv"%sigma,index=False,float_format='%.3f')
