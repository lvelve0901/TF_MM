...
df = pd.read_csv("../../PairTable_crystal.csv")

screenlist = ['RNA','Protein#RNA']
canonical = ['DA','DG','DC','DT']

pair = df.loc[(~df.mmtype.isin(screenlist)) & (df.reso <= 3.0)]
