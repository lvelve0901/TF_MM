...
for mismatch in mismatches:
    ...
    df = pd.read_csv("./dna_%s/DNA_mismatch_%s_crystal_automatic.csv"%(mismatch,mismatch.upper())) 
...
for pdbid in pdblist:
    os.system("cp /mnt/hs189/NAfinder_2.0_crystal/Crystal/%s.pdb ./raw_pdb/%s.pdb"%(pdbid,pdbid))
