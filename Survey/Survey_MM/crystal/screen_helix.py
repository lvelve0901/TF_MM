...
def filter_helix(input_file,output_file):
    ...
    all_bp = pd.read_csv('../../PairTable_crystal.csv')
    status_bp = []
...
def main():
    ...
    filelist = ["DNA_mismatch_GT_crystal","DNA_mismatch_AC_crystal","DNA_mismatch_GG_crystal","DNA_mismatch_AG_crystal","DNA_mismatch_AA_crystal","DNA_mismatch_TT_crystal","DNA_mismatch_CT_crystal","DNA_mismatch_CC_crystal"]
