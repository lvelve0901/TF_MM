...
bp_params = ['shear','stretch','stagger','buckle','propeller','opening','dist_c1pc1p','minorgw']

bdna_crystal = df_crystal.loc[(df_crystal['mmtype'].isin(['DNA'])) & (df_crystal['reso'] <= 3.0) 
...
bdna_nmr = df_nmr.loc[(df_nmr['mmtype'].isin(['DNA'])) 
