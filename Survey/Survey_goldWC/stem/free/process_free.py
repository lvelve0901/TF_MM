...
bdna_crystal = df_crystal.loc[(df_crystal['mmtype'] == 'DNA') & (df_crystal['reso'] <= 3.0) 
...
bdna_nmr = df_nmr.loc[(df_nmr['mmtype'] == 'DNA') 
...
cano_all.to_csv("Golden_WC_free.csv",index=False)
