...
pdb_dir = '/mnt/d4/hs189/TF/myc_max/myc_GA2_free/'
oupname = 'myc_GA2_free'
#mismatch = [['A.DA8','B.DT29']]
mismatch = [['A.DA8','B.DG29']]
targets = [['A.DC3','B.DG34'],['A.DT4','B.DA33'],['A.DG5','B.DC32'],['A.DC6','B.DG31'],['A.DC7','B.DG30']] + mismatch + [['A.DC9','B.DG28'],['A.DG10','B.DC27'],['A.DT11','B.DA26'],['A.DG12','B.DC25'],['A.DG13','B.DC24']]
...
for idx, pdb in enumerate(pdblist):
    ...
    for hel in hels:
        ...
        for j, target in enumerate(targets):
            if nt1_id in target and nt2_id in target:
                step = j
                isTarget = True
                break
            elif nt1_id not in target and nt2_id not in target:
                continue
            else:
...
df.to_csv("./Data/%s_all_step.csv"%oupname,index=False)
